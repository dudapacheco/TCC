...
public class listar_evolu extends AppCompatActivity{

    DatabaseReference databaseReference;
    FirebaseDatabase firebaseDatabase;
    FirebaseUser firebaseUser;
    ListView aliaslistview;
    private EditText filtroevolu;
    List<Aluno> alunosevolu=new ArrayList<Aluno>();
    private Aluno aluno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_evolu);


        aliaslistview=findViewById(R.id.listaevolu);
        filtroevolu = findViewById(R.id.filtrolistaevolu);
        inicializarFB();
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        menu.add(Menu.NONE,1,Menu.NONE,"Nova Evolução");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 1:
                Intent intent = new Intent(listar_evolu.this, cadastroEvolucao.class);
                intent.putExtra("Objeto", aluno);
                startActivity(intent);
                break;

            case 2:
                Intent intent1 = new Intent(listar_evolu.this, HistoricoEvolucao.class);
    ...
    private void eventoEdit() {
        ...
        filtroevolu.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                String palavra = filtroevolu.getText().toString().trim();
    ...
    private void pesquisarNome(String palavra) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                alunoArrayAdapter = new ArrayAdapter<Aluno>(listar_evolu.this, android.R.layout.simple_list_item_1, alunosevolu);
